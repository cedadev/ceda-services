"""
Custom form widgets for the ``ceda_services`` app.
"""
...
def generic_object_text(request):
    ...
    try:
        ...
        return HttpResponse(
            status = 400,
            content = 'Missing GET parameter(s).',
...
class AdminGfkObjectIdWidget(forms.TextInput):
    ...
    """
    class Media:
        js = ('admin/js/jquery.init.js', 'admin/js/admin_gfk_objectid_widget.js', )
