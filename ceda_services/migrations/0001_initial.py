# Generated by Django 2.2.4 on 2020-08-03 11:05

import ceda_services.models.access_control
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_ceda_services.behaviour_set+', to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expires', models.DateField(default=ceda_services.models.access_control._default_expiry, verbose_name='expiry date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('behaviour_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='ceda_services.Behaviour')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', related_query_name='service', to='ceda_services.Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('behaviours', models.ManyToManyField(related_name='roles', related_query_name='role', to='ceda_services.Behaviour')),
                ('metadata_form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='jasmin_metadata.Form')),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', related_query_name='role', to='ceda_services.Service')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grant', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='request', to='ceda_services.Grant')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', related_query_name='request', to='ceda_services.Role')),
        ...
        migrations.AddField(
            model_name='grant',
            name='role',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='grants', related_query_name='grant', to='ceda_services.Role'),
        ),
        migrations.AddField(
            model_name='grant',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='object_permissions', related_query_name='object_permission', to='ceda_services.Role')),
            ],
            options={
